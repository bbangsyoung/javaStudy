...
public class StudentSearchService {
	...
	public ArrayList<Student> getSearchStudentListByStudent_name(String student_name) throws Exception{
		...
		ArrayList<Student> searchStudentList = studentDAO.selectStudentListByStudent_name(student_name);
		close(con);
	...
	public ArrayList<Student> getSearchStudentListByStudent_no(int student_no) throws Exception{
		...
		Connection con = getConnection();
		StudentDAO studentDAO = new StudentDAO(con);
		ArrayList<Student> searchStudentList = studentDAO.selectStudentByStudent_no(student_no);
		close(con);
		return searchStudentList;
